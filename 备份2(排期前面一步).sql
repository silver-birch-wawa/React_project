...
INSERT INTO `articles` (`id`, `title`, `format`, `academicsec`, `column`, `keyword1_cn`, `keyword2_cn`, `keyword3_cn`, `keyword4_cn`, `keyword1_en`, `keyword2_en`, `keyword3_en`, `keyword4_en`, `summary_cn`, `summary_en`, `writer_id`, `writers_info`, `writer_prefer`, `writer_avoid`, `date_sub`, `date_pub`) VALUES
	(1, '测试1', '.docx;.rar', 1, 1, '测试1', NULL, NULL, NULL, 'test', NULL, NULL, NULL, '测试1', 'test', 1, 'test1', NULL, NULL, '2018-03-03 10:30:08', '2018-08-01 08:00:00'),
	(2, '测试2', '.docx;.rar', 1, 1, '测试2', NULL, NULL, NULL, 'test', NULL, NULL, NULL, '测试2', 'test2', 2, 'test2', NULL, NULL, '2018-05-03 10:30:09', '2018-09-01 08:00:02');
...
INSERT INTO `tasks` (`id`, `id_article`, `id_role`, `content`, `stat`, `role`, `flag`, `date`) VALUES
	...
	(3, 2, 3, NULL, 6, 2, 1, '2018-05-03 10:47:13'),
	(4, 1, 2, NULL, 6, 2, 0, '2018-05-03 10:47:13');
...
-- 正在导出表  newsroom.type_academicsec 的数据：~1 rows (大约)
...
-- 正在导出表  newsroom.type_column 的数据：~1 rows (大约)
...
-- 正在导出表  newsroom.type_education 的数据：~1 rows (大约)
...
-- 正在导出表  newsroom.type_major 的数据：~1 rows (大约)
