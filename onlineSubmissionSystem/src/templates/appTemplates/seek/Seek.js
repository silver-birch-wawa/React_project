...
class Seek extends Component
{
    ...
    {
        super()
        this.state = {startyear:0,endyaar:0,keyword:'',typs:0,page:1,articlelist:[]}
    }
    ...
    SeekFuction = () =>
    {
        ...
        axios(
            {
                method:'get',
                url:`/search/bykey/startyear=${this.state.startyear}&endyear=${this.state.endyear}&keyword=${this.state.keyword}&type=${this.state.type}&page=${this.state.page}`,
                headers:{
    ...
    {
        this.setState({
            keyword:sessionStorage.key(10),
            startyear:sessionStorage.key(11),
            endyaar:sessionStorage.key(12),
            type:sessionStorage.key(13),
