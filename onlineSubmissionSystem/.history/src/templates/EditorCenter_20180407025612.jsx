                ...
                <TabPane tab="未完成" key="1">
                    <Table 
                        ...
                        expandedRowRender={record => {
                            class ExpandedRowPro extends Component {
                                checkError = (id) => {
                                    ...
                                    return (
                                        <Form>
                                            <Row gutter={16}>
                                                <Col span={6}>
                                                    <FormItem
                                                        validateStatus={this.checkError('professior1') ? 'error' : ''}
                                                        help={this.checkError('professior1') || ''}
                                                        label={(
                                                            <span>
                                                                审稿人一
                                                            </span>
                                                    ...
                                                    >
                                                        {getFieldDecorator('professior1', {
                                                            rules: [{ required: true, message: '审稿人姓名不能为空!', whitespace: true }],
                                                        })(
                                                            <Input />
                                                        )}
                                                    </FormItem>
                                                ...
                                                <Col span={6}>
                                                    <FormItem
                                                        validateStatus={this.checkError('professior2') ? 'error' : ''}
                                                        help={this.checkError('professior2') || ''}
                                                        label={(
                                                            <span>
                                                                审稿人二
                                                            </span>
                                                ...
                                                <Col span={10}>
                                                    <FormItem
                                                        validateStatus={this.checkError('professior3') ? 'error' : ''}
                                                        help={this.checkError('professior3') || ''}
                                                        label={(
                                                            <span>
                                                                审稿人三
                                                            </span>
                            ...
                            class ExpandedRowSug extends Component {
                                checkError = (id) => {
                                    // Only show error after a field is touched.
                                    return this.props.form.isFieldTouched(id) && this.props.form.getFieldError(id)
                                }
                            ...
                            const ExpandedRowSugForm = Form.create({
                                mapPropsToFields(props) {
                                    console.log(props.record);
                                    return {
                                        receiptTitle: Form.createFormField({
                            ...
                            return (
                                <div>
                                    {record.thesisState === '待分配' ? 
                                        <ExpandedRowProForm record={record} onblur={this.handleFormChange} /> 
                                            : 
                                        <ExpandedRowSugForm record={record} onblur={this.handleFormChange} /> }
                                </div>
                            )
                        }}
