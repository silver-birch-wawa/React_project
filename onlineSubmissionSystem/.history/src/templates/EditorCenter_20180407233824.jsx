    ...
    constructor () {
        ...
        this.columnsUnfinished = [{
            ...
            render: (text, record) => {
                ...
                return (
                    <Input value={this.state.dataUnfinished[n].expense} />
                )
            }
        }, {
            title: '操作',
            ...
            render: (text, record) => {
                return(
                    <span>
						<Button type="primary" onClick={() => this.modalOpen(record, 'submitPayment')}>提交</Button>
					</span>
                )
            },
        }];
    ...
    render() {
        return (
            <Tabs animated={false} tabPosition="top" defaultActiveKey="1" style={{ paddingTop:'1rem' }}>
                ...
                <TabPane tab="已完成" key="2">
                    <Table loading={this.state.unfinishedLoading}columns={this.columnsFinished} dataSource={this.state.dataFinished} bordered />
                </TabPane>
            </Tabs>
        );
    }
