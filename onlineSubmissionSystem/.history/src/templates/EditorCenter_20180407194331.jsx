                ...
                <TabPane tab="未完成" key="1">
                    <Table 
                        ...
                        expandedRowRender={record => {
                            ...
                            return (
                                <ExpandedRowForm record={record} onblur={this.handleCompleteInput} />
                            )
                        }}
                    ...
                    <Modal
                        ...
                        title="提交确认"
                        footer={[
                            <Button key="submit" type="primary" size="large" onClick={this.submitRecord} loading={this.state.confirmLoading}>
                                确定
                            </Button>,
