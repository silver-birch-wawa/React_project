...
class Record extends Component{
    constructor () {
        ...
        this.columnsUnfinished = [{
            ...
            render: (text, record) => (
                <span>
                    <Button onClickonChange={(checked) => this.receiptChange(record, checked)}>
                ...
                <TabPane tab="未完成" key="1">
                    <Table 
                        ...
                        expandedRowRender={record => {
                            ...
                            return (
                                <ExpandedRowForm record={record} onblur={this.handleFormChange} />
                            )
                        }}
...
class Payment extends Component{
    ...
    render() {
        return (
            <Tabs animated={false} tabPosition="top" defaultActiveKey="1" style={{ paddingTop:'1rem' }}>
                <TabPane tab="未完成" key="1">
                    <Table className="authorTable" columns={this.columnsUnfinished} dataSource={this.state.dataUnfinished} bordered scroll={{ x: '77rem' }} />
                    <Modal
