                ...
                <TabPane tab="未完成" key="1">
                    <Table 
                        ...
                        expandedRowRender={record => {
                            ...
                            return (
                                <div>
                                    {record.thesisState === '待分配' ? '审阅分配' : '审阅意见' === "1" ? <ExpandedRowProForm record={record} onblur={this.handleFormChange} /> : null }
                                    {this.state.selectedKeys === "2" ? <ExpandedRowProForm record={record} onblur={this.handleFormChange} /> : null }
                                </div>
                            )
                        }}
